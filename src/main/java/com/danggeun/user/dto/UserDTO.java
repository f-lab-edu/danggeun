...
public class UserDTO {
	...
	private void validateUserNullable() {
		if (!StringUtils.hasText(this.getUserName()) || !StringUtils.hasText(this.getNickname())
			|| !StringUtils.hasText(this.getEmail()) || !StringUtils.hasText(this.getUserPassword()))
